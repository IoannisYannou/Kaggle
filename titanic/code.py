...
###################################
'''Standardize the columns of X_train in order to improve performance of the Logistic Regression Model &
   apply the same standardization parameters to X_test for consistency'''
sc = StandardScaler()
sc.fit(X_train)
...
print ("Train Test Accuracy: {}".format(sum(y_pred==y_test)/len(y_test)*100.0))
###################################